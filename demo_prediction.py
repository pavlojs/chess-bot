...
def test_prediction():
    ...
    prediction_move, mate_val, pred_cp = get_move_prediction(stockfish, "test_game", prediction_depth=10)
    print(f"Predicted move: {prediction_move}, mate: {mate_val}, cp: {pred_cp}\n")
    ...
    prediction_move, mate_val, pred_cp = get_move_prediction(stockfish, "test_game", prediction_depth=8)
    print(f"Predicted move: {prediction_move}, mate: {mate_val}, cp: {pred_cp}\n")
    ...
    prediction_move, mate_val, pred_cp = get_move_prediction(stockfish, "test_game", prediction_depth=6)
    print(f"Predicted move: {prediction_move}, mate: {mate_val}, cp: {pred_cp}\n")
